...
const classes = {
   container: `relative rounded before:absolute before:content-[""] before:inset-0 z-0 before:bg-amber-800 before:border-amber-900 before:z-[-1] `,
};
...
const FrameVariant = cva(classes.container, {
   variants: {
      size: {
         primary:
            "before:rounded-2xl before:bg-amber-800 rounded-2xl before:border-[4px] before:shadow-[0_4px_0_#78350f] p-[14px] active:translate-y-[4px]",
